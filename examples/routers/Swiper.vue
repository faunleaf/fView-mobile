<template>
  <div>
    <i-group-title>循环模式</i-group-title>
    <i-swiper loop auto :list="demo06_list" :index="demo06_index" @on-index-change="demo06_onIndexChange"></i-swiper>
    <p>current index: {{demo06_index}}</p>

    <i-group-title>循环模式（只有两个）</i-group-title>
    <i-swiper loop auto :list="demo07_list" :index="demo07_index" @on-index-change="demo07_onIndexChange"></i-swiper>

<template>
    ...
    <div class="weui-cell__ft">
      <i-icon type="clear" v-show="!equalWith && showClear && currentValue && !readonly && !disabled" @click.native="clear"></i-icon>

      <i-icon class="vux-input-icon" type="warn" :title="!valid ? firstError : ''" v-show="!novalidate && !equalWith && ((touched && !valid && firstError) || (forceShowError && !valid && firstError))"></i-icon>
      <i-icon class="vux-input-icon" type="warn" v-if="!novalidate && hasLengthEqual && dirty && equalWith && !valid"></i-icon>
      <i-icon type="success" v-show="!novalidate && equalWith && equalWith === currentValue && valid"></i-icon>

      <i-icon type="success" class="vux-input-icon" v-show="novalidate && iconType === 'success'"></i-icon>
      <i-icon type="warn" class="vux-input-icon" v-show="novalidate && iconType === 'error'"></i-icon>

<template>
  <div class="vux-picker">
    <i-flexbox :gutter="0">
      <i-flexbox-item :span="columnWidth && columnWidth[index]" v-for="(one, index) in currentData" :key="index" style="margin-left:0;">
...
export default {
  components: { iFlexbox, iFlexboxItem: iFlexbox.Item },
  created () {
    if (this.columns !== 0) {
